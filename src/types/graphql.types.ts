...
export type AllReportFragment = { __typename?: 'Report', id: string, title: string, content: string, tags?: Array<string> | null, createdAt: any, updatedAt: any };
...
export type GetReportQuery = { __typename?: 'Query', report: { __typename?: 'Report', id: string, title: string, content: string, tags?: Array<string> | null, createdAt: any, updatedAt: any, user: { __typename?: 'User', id: string, nickname: string }, _count: { __typename?: 'Count', userLiked: number }, book: { __typename?: 'BookObject', isbn13: string, title: string, author: string, description: string, cover: string, categoryId: number, categoryName: string, pubDate: string, publisher: string, priceStandard: number, customerReviewRank: number, subInfo: { __typename?: 'SubInfoObject', itemPage: number } } } };
...
export type CreateReportMutation = { __typename?: 'Mutation', book: { __typename?: 'BookObject', isbn13: string }, report: { __typename?: 'Report', id: string } };
...
export type ToggleReportLikeMutation = { __typename?: 'Mutation', message: { __typename?: 'Message', message: string } };
...
export type GetReportListBySearchQuery = { __typename?: 'Query', reportList: { __typename?: 'ReportListWithHasNext', hasNext: boolean, items: Array<{ __typename?: 'Report', id: string, title: string, content: string, tags?: Array<string> | null, createdAt: any, updatedAt: any, user: { __typename?: 'User', id: string, nickname: string }, _count: { __typename?: 'Count', userLiked: number }, book: { __typename?: 'BookObject', cover: string, title: string } }> } };

export type GetMostLikedReportListQueryVariables = Exact<{ [key: string]: never; }>;


export type GetMostLikedReportListQuery = { __typename?: 'Query', items: { __typename?: 'ReportList', items: Array<{ __typename?: 'Report', id: string, title: string, content: string, tags?: Array<string> | null, createdAt: any, updatedAt: any, user: { __typename?: 'User', id: string, nickname: string }, _count: { __typename?: 'Count', userLiked: number }, book: { __typename?: 'BookObject', cover: string, title: string } }> } };
